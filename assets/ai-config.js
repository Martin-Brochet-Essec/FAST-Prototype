...
window.FAST_AI_CONFIG = {
  ...
  // payante active.
  ANTHROPIC: { API_KEY: "REMPLACEZ_PAR_VOTRE_CLE_API", MODELE: "claude-sonnet-4-6" },
  OPENAI:    { API_KEY: "REMPLACEZ_PAR_VOTRE_CLE_API", MODELE: "gpt-4o-mini" },
  GEMINI:    { API_KEY: "REMPLACEZ_PAR_VOTRE_CLE_API", MODELE: "gemini-1.5-flash" },
  MISTRAL:   { API_KEY: "REMPLACEZ_PAR_VOTRE_CLE_API", MODELE: "mistral-small-latest" }
};
